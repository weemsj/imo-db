# IMO-DB
This website is created by [Brian Bourcy](https://github.com/bourcyb) and [Jacqueline Weems](https://github.com/weemsj) to be used by administration of a fictional fitness company. The administration will be able to CRUD all employees, members, classes, jobs, certifications and departments. 

# Web App
Web app is avalible to view [here](http://imofitness.link:5000/).

# Project Details

Full Executive Summary, Project outline, ERD, and Database Schema avalible [via Google Doc](https://docs.google.com/document/d/1G2f5M1lUuk-ZJ2exV9qsRDDLrh7t_7ckrPgzn6TWXds/edit?usp=sharing/)

or 

[IMO-DB Summary.pdf](https://github.com/weemsj/imo-db/files/8355089/IMO-DB.Summary.pdf)
...
dept_description: mediumtext, not NULL
...
#### ERD
![IMOdatabase-ERD(update2-10) drawio](https://user-images.githubusercontent.com/71594052/160233671-8c5e4717-8ecf-4102-993f-261f6570e202.svg)

#### Schema
![IMO-DB_shema](https://user-images.githubusercontent.com/71594052/160233852-bac7bdec-13d9-4645-b437-708d9e8c02d8.png)
